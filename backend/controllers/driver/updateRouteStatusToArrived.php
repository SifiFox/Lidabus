...
$object = json_decode($_POST['updateRouteStatusToArrived'], true);

updateRouteStatusToArrived($object);

function updateRouteStatusToArrived($object)
{
    include "../../database/dbConnection.php";
    include "../../utils/logger.php";

    $routeID = $object['ID_Route'];
    $statusToInWay = 'Прибыл';
